...
class TokenizerTest {
  ...
  public static Stream<Arguments> streamValidLexemesArguments() {
    return Stream.of(Arguments.of("(", TokenType.LEFT_PAREN), Arguments.of(")", TokenType.RIGHT_PAREN),
        Arguments.of("{", TokenType.LEFT_BRACE), Arguments.of("}", TokenType.RIGHT_BRACE),
        Arguments.of(".", TokenType.DOT), Arguments.of("+", TokenType.PLUS), Arguments.of("-", TokenType.DASH),
        Arguments.of("*", TokenType.STAR), Arguments.of("/", TokenType.SLASH), Arguments.of(",", TokenType.COMMA),
        ...
        Arguments.of("!=", TokenType.BANG_EQUAL), Arguments.of("and", TokenType.AND), Arguments.of("or", TokenType.OR),
        Arguments.of("var", TokenType.VAR), Arguments.of("new", TokenType.NEW), Arguments.of("class", TokenType.CLASS),
        Arguments.of("func", TokenType.FUNC), Arguments.of("if", TokenType.IF), Arguments.of("for", TokenType.FOR),
        ...
        Arguments.of("nil", TokenType.NIL), Arguments.of("else", TokenType.ELSE), Arguments.of("this", TokenType.THIS));
  }
  ...
  @CsvSource(textBlock = """
      ...
      '@', 'Illegal character at line 1, character 1'
      """)
  void givenInvalidLexemesWhenTokenizeThenThrowDetailedException(String input, String expectedMessage) {
    IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> tokenizer.tokenize(input));
  ...
  void givenValidLexemesWhenTokenizeThenReturnList(String input, TokenType type) {
    assertIterableEquals(List.of(new Token(type, 1, input, null), new Token(EOF, 1)), tokenizer.tokenize(input));
  }
  ...
  @CsvSource(textBlock = """
      ...
      """)
  void givenInvalidStringWhenTokenizeThenThrowDetailedException(String input, String expectedMessage) {
    IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> tokenizer.tokenize(input));
    assertEquals(expectedMessage, ex.getMessage());
  }
  ...
  @CsvSource(textBlock = """
      ...
      """)
  void givenInvalidNumberWhenTokenizeThenThrowDetailedException(String input, String expectedMessage) {
    IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> tokenizer.tokenize(input));
    assertEquals(expectedMessage, ex.getMessage());
  }
  ...
  void givenValidDoubleWhenTokenizeThenReturnList(String input) {
    assertIterableEquals(List.of(new Token(NUMBER, 1, input, Double.valueOf(input)), new Token(EOF, 1)),
  ...
  @CsvSource(textBlock = """
      ...
      """)
  void givenInvalidIdentifierLexemesWhenTokenizeThenThrowDetailedException(String input, String expectedMessage) {
    IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> tokenizer.tokenize(input));
    assertEquals(expectedMessage, ex.getMessage());
  }
  ...
  void givenIdentifierLexemeWhenTokenizeThenReturnList(String input) {
    assertIterableEquals(List.of(new Token(IDENTIFIER, 1, input, null), new Token(EOF, 1)), tokenizer.tokenize(input));
  }
